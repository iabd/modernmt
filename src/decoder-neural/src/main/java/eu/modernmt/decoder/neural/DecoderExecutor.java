...
public interface DecoderExecutor {
    ...
    void translate(PythonDecoder decoder, LanguageDirection language, List<TranslationSplit> splits, Collection<ScoreEntry> suggestions, Collection<ScoreEntry> terminologies) throws DecoderException;
